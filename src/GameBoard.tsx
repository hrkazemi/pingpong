...
class GameBoard extends React.Component<{}, any> {
  ...
  moveBoard = (playerBoard: any, isUp: any) => {
  ...
  touchingEdge = (pos: any) => (0 <= pos && pos < COL_SIZE) || (COL_SIZE * (ROW_SIZE - 1) <= pos && pos < COL_SIZE * ROW_SIZE)

  touchingPaddle = (pos: any) => {
  ...
  isScore = (pos: any) => (this.state.deltaX === -1 && pos % COL_SIZE === 0) || (this.state.deltaX === 1 && (pos + 1) % COL_SIZE === 0)
  ...
  touchingPaddleEdge = (pos: any) => this.state.player[0] === pos ||
